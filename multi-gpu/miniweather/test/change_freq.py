...
for cpp_file, prediction_file in zip(cpp_files, prediction_files):
    ...
    for line in lines_cpp_file:
        with open(max_perf_dir+"/"+cpp_file, 'a') as max_perf_file:
            if("parallel_for($mem_freq, $core_freq, " in line):
                max_perf_file.write(line.replace("parallel_for($mem_freq, $core_freq, ", "parallel_for(877,  " + str(max_perf_freqs[i])+","))
                i=i+1
            else: 
    ...
    for line in lines_cpp_file:
        with open(min_energy_dir+"/"+cpp_file, 'a') as min_energy_file:
            if("parallel_for($mem_freq, $core_freq, " in line):
                min_energy_file.write(line.replace("parallel_for($mem_freq, $core_freq, ", "parallel_for(877,  " + str(min_energy_freqs[i])+","))
                i=i+1
            else: 
    ...
    for line in lines_cpp_file:
        with open(min_edp_dir+"/"+cpp_file, 'a') as min_edp_file:
            if("parallel_for($mem_freq, $core_freq, " in line):
                min_edp_file.write(line.replace("parallel_for($mem_freq, $core_freq, ", "parallel_for(877,  " + str(min_edp_freqs[i])+","))
                i=i+1
            else: 
    ...
    for line in lines_cpp_file:
        with open(min_ed2p_dir+"/"+cpp_file, 'a') as min_ed2p_file:
            if("parallel_for($mem_freq, $core_freq, " in line):
                min_ed2p_file.write(line.replace("parallel_for($mem_freq, $core_freq, ", "parallel_for(877,  " + str(min_ed2p_freqs[i])+","))
                i=i+1
            else: 
